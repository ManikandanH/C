...
class Student{
    ...
    //if any constructor is provided then complier will no longer generate the default no param constuctor.
        Student(){
            age = 0; // Note this will not initialize this will assign since when executing this body of the constructor this particular member property will already be initialized.
            name = "";
        }

        // Student() :name{""}, age{0} {}// Initialization method
        ...
        // Student(string stu_name, int stu_age) :name{stu_name}, age{stu_age} {} // Initialization method
